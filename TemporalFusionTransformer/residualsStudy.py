...
def parse_args():
    parser = argparse.ArgumentParser(description='Analyze SimpleTFT model residuals and generate visualizations')
...
def create_visualizations(train_results, val_results, output_dir):
    ...
    # 12. TFT-specific: Time-based error analysis
    ...
    plt.grid(True, alpha=0.3)
    plt.savefig(os.path.join(output_dir, 'tft_residual_distribution.png'), dpi=300, bbox_inches='tight')
    plt.close()
