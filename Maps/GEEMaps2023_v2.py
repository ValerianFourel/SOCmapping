...
def export_geotiff(image, scale_factor, output_path):
    ...
    geemap.ee_export_image(image, filename=output_path, scale=scale, region=roi, crs=projection, file_per_band=False)
...
for collection in collections:
    ...
    try:
        ...
        if name == 'Soil_Evaporation':
            ...
            units = 'Area fraction'  # LAI pixel values 0-100 scaled by 0.1 to 0-10
        elif name == 'Elevation':
            units = 'meters'
