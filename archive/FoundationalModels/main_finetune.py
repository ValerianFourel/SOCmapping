...
import IEEE_TPAMI_SpectralGPT.util.lr_decay as lrd
import IEEE_TPAMI_SpectralGPT.util.misc as misc
from IEEE_TPAMI_SpectralGPT.util.datasets import build_fmow_dataset
from IEEE_TPAMI_SpectralGPT.util.pos_embed import interpolate_pos_embed
from IEEE_TPAMI_SpectralGPT.util.misc import NativeScalerWithGradNormCount as NativeScaler

import IEEE_TPAMI_SpectralGPT.models_vit

import IEEE_TPAMI_SpectralGPT.models_vit_group_channels

import IEEE_TPAMI_SpectralGPT.models_vit_tensor as models_vit_tensor

import warnings

warnings.filterwarnings("ignore")
#
from IEEE_TPAMI_SpectralGPT.engine_finetune import (train_one_epoch,
                             evaluate)
# from engine_finetune_BE import (train_one_epoch,
#                                 evaluate)
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model_type', default=None, choices=['group_c', 'tensor'],
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='./models/SpectralGPT/SpectralGPT+.pth',
    ...
    parser.add_argument('--dataset_type', default='rgb',
                        choices=['rgb', 'temporal', 'sentinel', 'euro_sat', 'naip', 'bigearthnet',
                                 'bigearthnet_finetune'],
