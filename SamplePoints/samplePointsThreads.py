...
def process_subfolder(subfolder_data):
    ...
    try:
        ...
        new_path = os.path.join('/home/vfourel/MasterThesis/Data_Dec2024/DataVersion1Mil/Data/Coordinates1Mil', *subfolders)
...
def process_all_subfolders(file_dict, df):
    ...
    print(f"\nSuccessfully processed {len(successful_paths)} out of {len(subfolder_data)} subfolders")
...
# Usage
process_all_subfolders(file_dict, df)
