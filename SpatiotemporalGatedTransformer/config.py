...
MAX_OC = 120  # WRB histosol threshold (organic soils excluded). Drops 0.93% of LUCAS Bavaria.
...
# Mirrors 2DCNN/config.py so the SGT model trains on the same 20-band stack
# as the other models in this repo.
# ---------------------------------------------------------------------------
