# Temporal Fusion Transformer (SGT) for Soil Organic Carbon (SOC) Prediction in Bavaria

This repository implements Temporal Fusion Transformer (SGT) models for predicting and mapping soil organic carbon (SOC) content across Bavaria, Germany, using multi-temporal satellite and environmental data from 2007-2023.

## Overview

We provide two SGT architectures that combine Convolutional Neural Networks (CNN) for spatial feature extraction with Transformer attention mechanisms for temporal sequence modeling:

- **SimpleSGT**: Streamlined SGT with essential components for efficient SOC prediction
- **EnhancedSGT**: Advanced SGT with multi-scale processing, enhanced attention, and hierarchical feature learning

Both models leverage the SGT's unique ability to handle heterogeneous inputs and capture complex temporal dependencies for improved SOC prediction accuracy.

![Mapping of SOC prediction using the 360k SimpleSGT for the year 2023](../assets/AllModelsComparison/AllModelsComparison_20kTransformer_MAX_OC_150_Beginning_2007_End_2023_InferenceTime2023_20250527_155525.png)

*Mapping of SOC prediction using the 360k SimpleSGT (2007-2023 dataset, inference time: 2023)*


![Mapping of SOC prediction using the 1.1mil EnhancedSGT for the year 2023](../assets/AllModelsComparison/AllModelsComparison_2milTransformer_MAX_OC_150_Beginning_2007_End_2023_InferenceTime2023_20250527_155525.png)
*Mapping of SOC prediction using the 1.1mil EnhancedSGT (2007-2023 dataset, inference time: 2023)*

## Model Architectures

### SimpleSGT (Recommended)
...
The GRN is a key SGT component that provides:
...
### Switch to Enhanced SGT

To use the EnhancedSGT model, modify the import in ```trainSimulations.py```:
```python
...
| Component | SimpleSGT | EnhancedSGT |
|-----------|-----------|-------------|
...
- **SimpleSGT**: Fast training, good baseline performance, suitable for most applications
- **EnhancedSGT**: Higher capacity, better complex pattern modeling, requires more computational resources
...
```
├── SimpleSGT.py                     # SimpleSGT architecture
├── EnhancedSGT.py                   # EnhancedSGT architecture
...
├── output/
│   └── SGT_experiment_[timestamp]/  # Organized experiment outputs
...
## SGT Advantages for SOC Prediction
...
1. **Use SimpleSGT** for most applications - good balance of performance and efficiency
...
- **Consider single transformer layer** for SimpleSGT to avoid overcomplexity

### Model Selection

- **SimpleSGT**: Production applications, limited computational resources
- **EnhancedSGT**: Research applications, complex temporal patterns, abundant data
...
If you use this SGT implementation for SOC prediction, please cite:

```
@software{SGT_soc_bavaria,
