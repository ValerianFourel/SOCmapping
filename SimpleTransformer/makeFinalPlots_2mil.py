...
Updated: Using 2mil SimpleTransformer version
"""
import pickle
import numpy as np
...
def print_statistics_summary(data):
    ...
    # Compute metrics
    train_r2, train_rmse, train_mae = compute_metrics(train_pred, train_target)
    val_r2, val_rmse, val_mae = compute_metrics(val_pred, val_target)
...
def create_predicted_vs_actual(data, output_dir='./plots'):
    ...
    # Compute R² values
    train_r2, _, _ = compute_metrics(train_pred, train_actual)
    val_r2, _, _ = compute_metrics(val_pred, val_actual)
...
def main():
    # Path to pickle file - UPDATED to 2mil SimpleTransformer version
    pkl_path = "/home/valerian/SGTPublication/residual_Maps_Bavaria_v3_2milSimpleTransformer/residual_Maps_Bavaria_v3_2milSimpleTransformer/analysis_results.pkl"
    output_dir = "./professional_plots_2mil_SimpleTransformer"
    
    print("\n" + "=" * 80)
    print("PROFESSIONAL RESIDUAL ANALYSIS PLOTS - 2mil SimpleTransformer")
    print("=" * 80 + "\n")
