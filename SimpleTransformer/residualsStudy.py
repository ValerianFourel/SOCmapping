...
from config import (TIME_BEGINNING, TIME_END, MAX_OC,
                   NUM_HEADS, NUM_LAYERS, bands_list_order, 
                   window_size, time_before)

def parse_args():
    parser = argparse.ArgumentParser(description='Analyze transformer model residuals and generate visualizations')
    parser.add_argument('--model-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/SimpleTransformer/finalResultsMAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_composite_l2/transformer_model_run_4_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_R2_0.4444_TRANSFORM_none_LOSS_composite_l2.pth', help='Path to the trained model .pth file')
    parser.add_argument('--data-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/SimpleTransformer/finalResultsMAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_composite_l2/train_val_data_run_4_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_composite_l2.parquet', help='Path to the parquet file containing train/val data')
    parser.add_argument('--stats-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/SimpleTransformer/finalResultsMAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_composite_l2/normalization_stats_run_4_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_composite_l2.pkl', help='Path to normalization stats pickle file')
    ...
    parser.add_argument('--num-heads', type=int, default=NUM_HEADS, help='Number of attention heads')
    parser.add_argument('--num-layers', type=int, default=NUM_LAYERS, help='Number of transformer layers')
...
def remove_module_prefix(state_dict):
    """Remove 'module.' prefix from state dict keys if present (for DataParallel models)"""
    new_state_dict = {}
...
def load_model(model_path, device, num_heads, num_layers):
    ...
    if 'model_state_dict' in checkpoint:
        ...
        print(f"Loaded model from checkpoint with keys: {list(checkpoint.keys())}")
    else:
...
def main():
    ...
    # Load the model
    model = load_model(args.model_path, device, args.num_heads, args.num_layers)
