...
# at MAX_OC=150 on the 1mil run-1 split, R²=0.6909).
# Verified against the predictions in analysis_results.pkl by
# verify_model_a_architecture.py (commit on bestrun-bands).
# --------------------------------------------------------------------------
DEFAULT_PTH = (
