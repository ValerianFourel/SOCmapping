...
def parse_args():
    ...
    parser.add_argument('--model-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/3DCNN/train_val_data_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse/cnn_model_BEST_OVERALL_from_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse_R2_0.2101.pth', help='Path to the trained model .pth file')
    parser.add_argument('--data-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/3DCNN/train_val_data_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse/train_val_data_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse.parquet', help='Path to the parquet file containing train/val data')
    parser.add_argument('--stats-path', type=str, default='/home/vfourel/SOCProject/SOCmapping/3DCNN/train_val_data_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse/normalization_stats_run_3_MAX_OC_150_TIME_BEGINNING_2007_TIME_END_2023_TRANSFORM_none_LOSS_mse.pkl', help='Path to normalization stats pickle file')
